...
namespace ACHEQA_Parametric_Automation
    ...
    public partial class InputVariables : System.Web.UI.Page
        ...
        string tagNum = "";
        string qType = "";
        List<string> lstRefList = new List<string>();
        protected void Page_Load(object sender, EventArgs e)
            ...
            if (!IsPostBack)
                ...
                GF.UpdateBreadCrum(this.Master, qType, jobNum, tagNum, "Input Variables");
        ...
        protected void SaveInputVariables()
            ...
            try
                ...
                if (cls_InputVariable_BAL.Save_InputVariable_BAL(objEntity) > 0)
                    {
        ...
        protected void dgvInputVariables_RowCommand(object sender, GridViewCommandEventArgs e)
            ...
            try
                ...
                if (e.CommandName == "btnEdit")
                    ...
                    txtLookupCat.Text = lblLookCat.Text;
        ...
        private void SaveRefCaluse()
            ...
            try
                ...
                cls_Procedures_BAL.Save_ProcRefClause_BAL(dtTemp);
                }
            catch (Exception ex)
                {
        ...
        protected void chkLink_CheckedChanged(object sender, EventArgs e)
            ...
            if (cb1.Checked == true) lstRefList.Add(lblSerialNumber.Text); // lblRefSelected.Text = lblRefSelected.Text + lblSerialNumber.Text + ",";
            else
                {
                lstRefList.Remove(lblSerialNumber.Text);
            ...
            foreach (var item in lstRefList)
                {
                lblRefSelected.Text = lblRefSelected.Text + item + ",";
                }
            if(lblRefSelected.Text == "Selected Reference Clauses are: ")lblRefSelected.Text = lblRefSelected.Text.TrimEnd(',');
            this.modelProcNotes.Show();
            //here you can find your control and get value(Id).

            }

        //protected void dgvRefClause_RowCommand(object sender, GridViewCommandEventArgs e)
        //    {
        //    try
        //        {
        //        if (e.CommandName == "chkLink")
        //            {
        //            CheckBox chk = (CheckBox)(e.CommandSource);
        //            GridViewRow selectedrow = (GridViewRow)(chk.NamingContainer);
        //            Label lblRefSelected = (Label)selectedrow.FindControl("lblRefSelected");
        //            Label lblSerialNumber = (Label)selectedrow.FindControl("lblSerialNumber");

        //            lblRefSelected.Text = lblRefSelected.Text + lblSerialNumber.Text + ",";
        //            lblSerialNumber.Text.TrimEnd(',');
        //            }
        //        }
        //    catch (Exception ex)
        //        {
        //        lblerr.Text = "Ref Clause select - " + ex.Message;
        //        }
        //    }
        }
    }