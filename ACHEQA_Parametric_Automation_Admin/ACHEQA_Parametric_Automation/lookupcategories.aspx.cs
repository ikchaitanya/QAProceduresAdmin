        ...
        protected void dlentry_ItemCommand(object source, DataListCommandEventArgs e)
            ...
            try
                ...
                if (e.CommandName == "UPDATE")
                    {
                    if (((TextBox)e.Item.FindControl("TXT_LOOKUP_CATG_NAME_1")).Text == "" || ((TextBox)e.Item.FindControl("TXT_CATG_DESCRIPTION_1")).Text == "") lblerr.Text = "Fields marked with * can not be blank";
                    else
                        {
                        ...
                        lblerr.Text = cls_Lookup_BAL.Save_LookupCategiries_BAL(objEntity);
